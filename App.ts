...
class App {
  ...
  async accessTransportation(res: Response<any, Record<string, any>, number>, payload: { speed?: string | string[] | { $gte: string | string[] | undefined; } | undefined; vehicle?: string; }, api: string) : Promise<any> {
